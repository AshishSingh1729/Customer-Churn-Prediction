...
def predict():
   ...
   # df_1[[ 'MonthlyCharges', 'TotalCharges']] = scaler.fit_transform(df_1[[ 'MonthlyCharges', 'TotalCharges']])
   # df_2[[ 'MonthlyCharges', 'TotalCharges']] = scaler.transform(new_df[[ 'MonthlyCharges', 'TotalCharges']])
    ...
    df_3=pd.concat([df_2[['SeniorCitizen', 'MonthlyCharges', 'TotalCharges']],new_df__dummies],axis=1)
    ...
    if single==1:
        ...
        o2 = "Confidence %% of churning: {}".format(probablity*100)
    else:
